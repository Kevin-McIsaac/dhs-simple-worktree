 ...
 *
 * No UI of its own any more. Two responsibilities, both behind
 * window.__dshWorktreeSession for the hash-guarded sidebar patch to call:
 *
 ...
 *
 * The input-bar chip and its popover are gone: the + button owns creation and
 * the ⋯ menu owns deletion.
 */
