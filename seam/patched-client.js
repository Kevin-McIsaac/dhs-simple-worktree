									...
									(0, react_jsx_runtime.jsx)(ProjectRowItem, {
										...
										onCreate: () => {
											if (group.workspaceId !== void 0) {
												...
												const nativeCreate = () => startSession(group.workspaceId);
												/* dsh-worktree-session:patch — the plugin, when loaded, cuts a worktree and
												 * births the session in it; anything else (plugin absent, route down, not a
												 * git repo) falls through to the untouched native flow. */
												if (typeof window !== "undefined" && window.__dshWorktreeSession !== void 0 && window.__dshWorktreeSession.openForWorkspace !== void 0) window.__dshWorktreeSession.openForWorkspace(group.workspaceId, nativeCreate);
												else nativeCreate();
											}
										},
